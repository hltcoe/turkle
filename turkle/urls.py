...
urlpatterns = [
    ...
    url(r'^task/(?P<hit_id>\d+)/$', preview, name='preview'),
    url(r'^task/(?P<hit_id>\d+)/iframe/$', preview_iframe, name='preview_iframe'),
    url(r'^task/(?P<hit_id>\d+)/assignment/(?P<hit_assignment_id>\d+)/return/$',
        return_hit_assignment, name='return_hit_assignment'),
    url(r'^task/(?P<hit_id>\d+)/assignment/(?P<hit_assignment_id>\d+)/$',
        hit_assignment, name='hit_assignment'),
    url(r'^task/(?P<hit_id>\d+)/assignment/iframe/(?P<hit_assignment_id>\d+)/$',
