...
## [Unreleased]
### Changed
 - Updated the index page to better show current assignments
### Added
 - New tagging demo templates
### Fixed
 - Fixed date sorting issue on index page
 - Fixed issue where negative could be assigned to a task
